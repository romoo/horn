...
import { convertTextToSpeechAction } from '@/app/jing/actions';
import { toast } from 'sonner';
// import { TTSSettings } from '@/app/account/settings/text-to-speech/page';

type TTSSettings = any;
    ...
    if (typeof window !== 'undefined') {
      return JSON.parse(
        localStorage.getItem('readiumx-text-to-speech-settings') ||
          `{"api":"openai","settings":{"voice":"Alloy","model":"tts-1","speed":1}}`,
      );
    }
    return {
      api: 'openai',
      settings: { voice: 'Alloy', model: 'tts-1', speed: 1 },
    };
  });
